...
INTERFACE para_merge
  MODULE PROCEDURE para_merge_real0, para_merge_real1, para_merge_real2, para_merge_real3, para_merge_cmplx0, para_merge_cmplx1, para_merge_cmplx3, para_merge_cmplx4
END INTERFACE
  !
CONTAINS
  !
...
SUBROUTINE para_merge_real3(dat, size1, size2, size3)
  !
  use constants, only : dp
  !
  implicit none
  !
  integer :: size1, size2, size3
  real(dp) :: dat(1:size1, 1:size2, 1:size3)
  !
  integer ierr, dat_size
  !
  real(dp), allocatable :: buf(:, :, :)
